...
if __name__ == '__main__':
    ...
    checkins_file = project_path + '/data/'+'Yelp'+'/An-Experiment/'+'Yelp_check_ins.txt'
    social_file = project_path + '/data/'+'Yelp'+'/An-Experiment/'+'Yelp_social_relations.txt'
    checkins_dict_path = project_path + '/data/'+'Yelp'+'/inter/'+'user_poi.pkl'
    social_dict_path = project_path + '/data/'+'Yelp'+'/inter/'+'user_friend.pkl'
    writeToFile = False
    try:
    ...
    if writeToFile:
        ...
        # with open('/Users/wangnana/学习/小论文/New_cssc-MLP/data/Gowalla/user_poi.pkl', 'rb')as f:
